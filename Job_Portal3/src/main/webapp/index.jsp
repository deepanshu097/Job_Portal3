...
<div class="d-flex container " >	
		<div class=" form-body col-lg-2  mt-5  bg-white offset-lg-1 col-sm-8 ">
				<form method="post" action="searched.jsp" class=" form-body bg-white border mt-3 " >
				  <h6 class=" offset-lg-2 mt-3">filter<i cl11ass="fa-solid fa-filter mx-2"></i></h6>
				...
				<div class="form-floating btn my-2">
		...
		<div class="container-fluid m-5 ">
			...
			<div class="job_card" >
			<div class="post-icon offset-5  "><i class="fa fa-space-shuttle my-auto " aria-hidden="true">All Jobs</i></div>
				...
				<div class="description my-3 offset-lg-1">
					...
					<div class="form-floating btn offset-lg-1 mb-3  p-0 ">
					  <a href="one_view.jsp?id=<%=j.getId()%>" class="btn btn-control  border">View Job</a> 
					<a href="apply.jsp?id=<%=j.getId()%>" class="btn btn-control mx-3 border">Apply</a>
